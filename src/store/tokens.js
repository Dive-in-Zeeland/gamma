...
const tokens = {
  'APV': {
    place: 'APV',
    content: 'This is the place where almost all international student from the HZ Green Wood campus are living at.',
  ...
  'HZ': {
    place: 'HZ',
    content: 'This is our university Campus called Green Wood. The programms that are thought here are called: Architecture, HBO-ICT, Global Project and Change Management, Industrial Engineering (full-time), Water Management, Civil Engineering and the Masters in River Delta Development',
  ...
  'AH': {
    place: 'AH',
    content: 'Closest and largest supermarket next to the APV housing and HZ University campus. Here almost all students are buying their food. Here also can be found a TSmoskes, where the most frequent buyer is Deyan.',
